...
This project focuses on practicing **Flexbox** layout techniques by recreating a provided design mockup from scratch using only HTML and CSS.
...
- Flexbox for both horizontal and vertical layouts
- CSS custom properties and color styling
- Building from a design spec (colors, typography, spacing)
